...
public record OrderDetailDto(Guid Id, long CreatedOnUtc, long? ModifiedOnUtc, Guid UserId, string Status, ICollection<CourseDetailDto> Courses, string City, string Country, string Address, string ZipCode, string TcNo);
